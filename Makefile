...
LIBRARIES += glog gflags protobuf boost_system boost_filesystem boost_regex m hdf5_hl hdf5 opencv_core opencv_imgproc opencv_imgcodecs opencv_videoio
...
ifeq ($(USE_OPENCV), 1)
	...
	ifeq ($(OPENCV_VERSION), 3)
		LIBRARIES += opencv_imgcodecs opencv_videoio opencv_core opencv_imgproc 
	endif
